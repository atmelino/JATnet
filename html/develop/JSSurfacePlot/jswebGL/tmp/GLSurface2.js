 ...
 */
GLSurface2 = function(data3D, surfacePlot){
...
GLSurface2.prototype.draw = function(){
    ...
    this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.surfaceVertexNormalBuffer);
    this.gl.vertexAverticesttribPointer(this.currentShader.vertexNormalAttribute, this.surfaceVertexNormalBuffer.itemSize, this.gl.FLOAT, false, 0, 0);
